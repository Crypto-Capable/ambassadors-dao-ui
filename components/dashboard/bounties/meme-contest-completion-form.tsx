...
export type MemeContestCompletionFormProps = {
  onSubmitStart: () => void;
...
export const MemeContestCompletionForm: React.FC<
  MemeContestCompletionFormProps
  ...
  return (
    <chakra.form mt="4" experimental_spaceY="4" onSubmit={handleProposalSubmit}>
      ...
      <FormControl isRequired>
        ...
        />
        <FormHelperText>
          The number of submissions that were made for this meme contest.
        </FormHelperText>
      </FormControl>
